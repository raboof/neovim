...
--- Reset the lenses
---
---@param client_id number|nil Resets lenses of the given client_id, or all if nil
---@param bufnr number|nil Reset lenses for the given buffer, or all buffers if nil
